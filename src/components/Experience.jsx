...
const Experience = () => {
  return (
    <div id="experience" className="flex min-h-screen w-full flex-col items-center justify-center gap-20 p-16 md:p-20    lg:px-36 lg:py-16">
      <h1 className="text-center text-5xl font-light">Experience</h1>

      <div className="flex flex-wrap gap-0 md:flex-nowrap md:gap-12">
        <div className="flex-1">
          <div className="relative space-y-1 border-l-2 p-6 text-left">
